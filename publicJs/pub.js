const pub = {
  machine: "进入网站模板,website_znxy",
  // 公共接口地址
  _url: "http://192.168.35.246/CMS",
  // 详细接口api地址
  _DetailApi: {
      gaikuo:'/web/column/column_list_tree',//二级栏目树
      wz:'/web/column/articles_list_tree_easy',//文章列表树,用来获取文章的id
      article:'/web/article/article_msg',   //获取栏目下文章内容
      getHeader:'/web/homapage/getHeader',  //获取顶部导航信息
      getFooter:'/web/homapage/getFooter',   //获取页面底部信息
      getHomePage:'/web/homapage/getHomepage',//获取首页信息
      //getList:'/web/column/column_articles_list_page', //获取列表栏
      getCont:'/web/article/article_msg',  //获取文章详情
      getColumn:'/web/column/columns_articles_list_tree', //获取文章详情列表
      getStudy:'/web/article/article_msg', //右侧文章，左侧导航栏
